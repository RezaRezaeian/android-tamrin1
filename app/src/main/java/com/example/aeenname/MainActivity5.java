        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (btnTrue.isChecked()) {
                    ++True;
                    Toast.makeText(MainActivity5.this, "صحیح", Toast.LENGTH_SHORT).show();
                    Intent intentOk =new Intent (MainActivity5.this,MainActivity6.class);
                    ...
                    Intent intentFalse =new Intent (MainActivity5.this,MainActivity6.class);
