        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (btnTrue.isChecked()) {
                    ++True;
                    Toast.makeText(MainActivity4.this, "صحیح", Toast.LENGTH_SHORT).show();
                    Intent intentOk =new Intent (MainActivity4.this,MainActivity5.class);
                    ...
                    Toast.makeText(MainActivity4.this, "یک گزینه انتخاب کنید", Toast.LENGTH_SHORT).show();
                } else {
                    ++False;
                    Toast.makeText(MainActivity4.this, "غلط", Toast.LENGTH_LONG).show();
                    Intent intentFalse =new Intent (MainActivity4.this,MainActivity5.class);
